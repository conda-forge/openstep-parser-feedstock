...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/openstep-parser-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14160&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/openstep-parser-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `openstep-parser` can be installed with:

```
conda install openstep-parser
```

It is possible to list all of the versions of `openstep-parser` available on your platform with:
